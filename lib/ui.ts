...
const UI: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    /* 하네스 도식(components/HarnessFlow.tsx)의 마디 라벨. 수치는 코드가 아니라 데이터가 넣는다. */
    "UI.stageOrchestrate": "조율",
    "UI.stagePropose": "제안",
    "UI.stageVerify": "검증",
    "UI.stageGate": "게이트",
    "UI.stageExecute": "실행",
    "UI.stageAgentUnit": "에이전트",
    "UI.stageSystemUnit": "개 시스템",
    "UI.flowStop": "여기서 멈춘다",
    "UI.flowCaption":
      "시스템 {systems}개 · 에이전트 {agents}명. 이 가운데 {gated}개 시스템에는 혼자 집행을 멈출 수 있는 역할이 데이터에 명시돼 있습니다. 게이트 다음으로 가는 선이 그려지지 않은 이유입니다.",
    "UI.teamStripGate": "멈출 수 있는 자리",
    "UI.emailLabel": "이메일",
  ...
  en: {
    ...
    /* Stage labels for the harness diagram (components/HarnessFlow.tsx). Data supplies the numbers. */
    "UI.stageOrchestrate": "Coordinate",
    "UI.stagePropose": "Propose",
    "UI.stageVerify": "Verify",
    "UI.stageGate": "Gate",
    "UI.stageExecute": "Execute",
    "UI.stageAgentUnit": "agents",
    "UI.stageSystemUnit": "systems",
    "UI.flowStop": "stops here",
    "UI.flowCaption":
      "{systems} systems, {agents} agents. In {gated} of them the data names a role that can halt execution on its own. That is why no line is drawn past the gate.",
    "UI.teamStripGate": "Can halt it",
    "UI.emailLabel": "Email",
    "UI.githubLabel": "GitHub",
    "UI.linkedinLabel": "LinkedIn",
  },
